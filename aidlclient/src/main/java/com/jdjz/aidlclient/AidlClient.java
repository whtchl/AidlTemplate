...
import com.jdjz.myaidl.IMyAidlInterface;

public class AidlClient extends AppCompatActivity implements View.OnClickListener {
    ...
    private void bindService() {
        ...
        intent.setComponent(new ComponentName("com.jdjz.myaidl", "com.jdjz.myaidl.IRemoteService"));
